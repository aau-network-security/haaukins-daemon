...
SELECT id, tag, organization, name, initial_labs, max_labs, status, frontend, exercises, started_at, finish_expected, finished_at, createdby, secretkey FROM events WHERE tag = $1
`
...
SELECT id, tag, organization, name, initial_labs, max_labs, status, frontend, exercises, started_at, finish_expected, finished_at, createdby, secretkey FROM events WHERE organization = $1
`
...
SELECT id, tag, organization, name, initial_labs, max_labs, status, frontend, exercises, started_at, finish_expected, finished_at, createdby, secretkey FROM events WHERE organization = $1 AND createdBy = $2
`
...
SELECT id, tag, organization, name, initial_labs, max_labs, status, frontend, exercises, started_at, finish_expected, finished_at, createdby, secretkey FROM events WHERE organization = $1 AND status = $2
`
...
SELECT id, tag, organization, name, initial_labs, max_labs, status, frontend, exercises, started_at, finish_expected, finished_at, createdby, secretkey FROM events WHERE organization = $1 AND status = $2 AND createdBy = $3
`
